...
bool
resolver_discovery_add(const domainname * const NONNULL domain_to_discover)
{
	bool succeeded;
...
bool
resolver_discovery_remove(const domainname * const NONNULL domain_to_discover)
{
	...
	const ResourceRecord * const NONNULL answer, const QC_result change_event)
{
	...
	if (change_event == QC_add) {
		...
		// Stop all the address query started by this resolver name
