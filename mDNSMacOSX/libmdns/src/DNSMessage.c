		...
		OSStatus * const		outError )
{
	...
	for( i = 0; i < 2; ++i )
	{
		...
		if( !bufPtr )
		{
			...
			bufPtr = (uint8_t *) mdns_calloc( 1, bufLen );
...
OSStatus	DomainNameDupEx( const uint8_t *inName, Boolean inLower, uint8_t **outNamePtr, size_t *outNameLen )
{
	...
	namePtr = (uint8_t *) mdns_malloc( nameLen );
...
//===========================================================================================================================
// This code was autogenerated on 2020-09-18 by dns-rr-func-autogen version 1.4
// Data source URL: https://www.iana.org/assignments/dns-parameters/dns-parameters-4.csv
// Overrides: none

const char *	DNSRecordTypeValueToString( const int inValue )
{
	switch( inValue )
	{
...
uint16_t	DNSRecordTypeStringToValue( const char * const inString )
{
	...
	{
		{ "A",          kDNSRecordType_A             },
		{ "A6",         kDNSRecordType_A6            },
		{ "AAAA",       kDNSRecordType_AAAA          },
		{ "AFSDB",      kDNSRecordType_AFSDB         },
		{ "AMTRELAY",   kDNSRecordType_AMTRELAY      },
		{ "ANY",        kDNSRecordType_ANY           },
		{ "APL",        kDNSRecordType_APL           },
		{ "ATMA",       kDNSRecordType_ATMA          },
		{ "AVC",        kDNSRecordType_AVC           },
		{ "AXFR",       kDNSRecordType_AXFR          },
		{ "CAA",        kDNSRecordType_CAA           },
		{ "CDNSKEY",    kDNSRecordType_CDNSKEY       },
		{ "CDS",        kDNSRecordType_CDS           },
		{ "CERT",       kDNSRecordType_CERT          },
		{ "CNAME",      kDNSRecordType_CNAME         },
		{ "CSYNC",      kDNSRecordType_CSYNC         },
		{ "DHCID",      kDNSRecordType_DHCID         },
		{ "DLV",        kDNSRecordType_DLV           },
		{ "DNAME",      kDNSRecordType_DNAME         },
		{ "DNSKEY",     kDNSRecordType_DNSKEY        },
		{ "DOA",        kDNSRecordType_DOA           },
		{ "DS",         kDNSRecordType_DS            },
		{ "EID",        kDNSRecordType_EID           },
		{ "EUI48",      kDNSRecordType_EUI48         },
		{ "EUI64",      kDNSRecordType_EUI64         },
		{ "GID",        kDNSRecordType_GID           },
		{ "GPOS",       kDNSRecordType_GPOS          },
		{ "HINFO",      kDNSRecordType_HINFO         },
		{ "HIP",        kDNSRecordType_HIP           },
		{ "HTTPS",      kDNSRecordType_HTTPS         },
		{ "IPSECKEY",   kDNSRecordType_IPSECKEY      },
		{ "ISDN",       kDNSRecordType_ISDN          },
		{ "IXFR",       kDNSRecordType_IXFR          },
		{ "KEY",        kDNSRecordType_KEY           },
		{ "KX",         kDNSRecordType_KX            },
		{ "L32",        kDNSRecordType_L32           },
		{ "L64",        kDNSRecordType_L64           },
		{ "LOC",        kDNSRecordType_LOC           },
		{ "LP",         kDNSRecordType_LP            },
		{ "MAILA",      kDNSRecordType_MAILA         },
		{ "MAILB",      kDNSRecordType_MAILB         },
		{ "MB",         kDNSRecordType_MB            },
		{ "MD",         kDNSRecordType_MD            },
		{ "MF",         kDNSRecordType_MF            },
		{ "MG",         kDNSRecordType_MG            },
		{ "MINFO",      kDNSRecordType_MINFO         },
		{ "MR",         kDNSRecordType_MR            },
		{ "MX",         kDNSRecordType_MX            },
		{ "NAPTR",      kDNSRecordType_NAPTR         },
		{ "NID",        kDNSRecordType_NID           },
		{ "NIMLOC",     kDNSRecordType_NIMLOC        },
		{ "NINFO",      kDNSRecordType_NINFO         },
		{ "NS",         kDNSRecordType_NS            },
		{ "NSAP",       kDNSRecordType_NSAP          },
		{ "NSAP-PTR",   kDNSRecordType_NSAP_PTR      },
		{ "NSEC",       kDNSRecordType_NSEC          },
		{ "NSEC3",      kDNSRecordType_NSEC3         },
		{ "NSEC3PARAM", kDNSRecordType_NSEC3PARAM    },
		{ "NULL",       kDNSRecordType_NULL          },
		{ "NXT",        kDNSRecordType_NXT           },
		{ "OPENPGPKEY", kDNSRecordType_OPENPGPKEY    },
		{ "OPT",        kDNSRecordType_OPT           },
		{ "PTR",        kDNSRecordType_PTR           },
		{ "PX",         kDNSRecordType_PX            },
		{ "Reserved",   kDNSRecordType_Reserved      },
		{ "RKEY",       kDNSRecordType_RKEY          },
		{ "RP",         kDNSRecordType_RP            },
		{ "RRSIG",      kDNSRecordType_RRSIG         },
		{ "RT",         kDNSRecordType_RT            },
		{ "SIG",        kDNSRecordType_SIG           },
		{ "SINK",       kDNSRecordType_SINK          },
		{ "SMIMEA",     kDNSRecordType_SMIMEA        },
		{ "SOA",        kDNSRecordType_SOA           },
		{ "SPF",        kDNSRecordType_SPF           },
		{ "SRV",        kDNSRecordType_SRV           },
		{ "SSHFP",      kDNSRecordType_SSHFP         },
		{ "SVCB",       kDNSRecordType_SVCB          },
		{ "TA",         kDNSRecordType_TA            },
		{ "TALINK",     kDNSRecordType_TALINK        },
		{ "TKEY",       kDNSRecordType_TKEY          },
		{ "TLSA",       kDNSRecordType_TLSA          },
		{ "TSIG",       kDNSRecordType_TSIG          },
		{ "TXT",        kDNSRecordType_TXT           },
		{ "UID",        kDNSRecordType_UID           },
		{ "UINFO",      kDNSRecordType_UINFO         },
		{ "UNSPEC",     kDNSRecordType_UNSPEC        },
		{ "URI",        kDNSRecordType_URI           },
		{ "WKS",        kDNSRecordType_WKS           },
		{ "X25",        kDNSRecordType_X25           },
		{ "ZONEMD",     kDNSRecordType_ZONEMD        },
	};
...
static int	_DNSRecordTypeStringToValueCmp( const void * const inKey, const void * const inElement )
{
