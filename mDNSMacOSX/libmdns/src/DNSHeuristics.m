                     ...
                     value:(NSDictionary *)value
{
    ...
    const Boolean ok = WiFiManagerClientSetNetworkProperty(manager, network, (__bridge CFStringRef)DNSFailureStateKey, (__bridge CFDictionaryRef)value);
    return (ok ? YES : NO);
}
                     ...
                     network:(WiFiNetworkRef)network
{
    ...
    const Boolean ok = WiFiManagerClientSetNetworkProperty(manager, network, (__bridge CFStringRef)DNSHeuristicsFilterFlagKey, kCFBooleanTrue);
    return (ok ? YES : NO);
}
                       ...
                       network:(WiFiNetworkRef)network
{
    ...
    const Boolean ok = WiFiManagerClientSetNetworkProperty(manager, network, (__bridge CFStringRef)DNSHeuristicsFilterFlagKey, kCFBooleanFalse);
    return (ok ? YES : NO);
}
